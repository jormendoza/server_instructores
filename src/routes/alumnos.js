...
router.post('/alumnos/', urlencodedParser, (req, res) => {
    const { nombres, apellidos, dni, celular, mail, direccionCalle, direccionNumero, direccionBarrio, direccionLocalidad } = req.body;
    ...
    var valores = [nombres, apellidos, dni, celular, mail, direccionCalle, direccionNumero, direccionBarrio, direccionLocalidad];
